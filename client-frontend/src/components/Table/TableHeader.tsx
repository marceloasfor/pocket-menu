...
function TableHeader() {
    ...
    return (
        <div className="sticky top-0 basis-[7%] border-b-2 flex items-center justify-between p-2 content-center font-medium bg-white">
            {modal}
            ...
            <p className="m-0 text-xl">Welcome to Table {tableCode}</p>
        </div>
    );
}
